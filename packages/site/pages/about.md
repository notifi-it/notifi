...
path: /about
eyebrow: About
title: notifi: about the service and who builds it
description: Who builds notifi, how the service is hosted and paid for, what it promises, and what it deliberately is not. One developer, one open-source codebase, one endpoint.
ogTitle: About notifi
ogDescription: One developer, one open-source codebase, one endpoint. How notifi is built, hosted and funded, and what it is not.
schemaType: AboutPage
schemaName: About notifi
schemaDescription: Who builds notifi, how it is hosted, and what it deliberately does not do.
---
# About notifi
...
Delivery is not guaranteed. Apple's push service is best-effort and so is notifi, which is why the [terms](/terms) ask you not to make it the only path for anything where a missed notification causes harm.

## Where to go next

- [API documentation](/docs) — the endpoint, its parameters and its error codes.
- [llms.txt](/llms.txt) — the same thing as plain text, written for coding agents.
- [FAQ](/faq) — cost, limits, encryption, what happens when you delete the app.
- [Privacy policy](/privacy) and [terms of service](/terms).
- [Contact](/contact) — how to reach a human about notifi.
