...
export const fr: Translation = {
  ...
  'api.noMacBuild': "Aucune build macOS n'a encore été publiée.",
  'api.noSuchBuild': 'Aucune build de ce type.',
  ...
  'inbox.bandEarlierThisWeek': 'Plus tôt cette semaine',
  'inbox.bandEarlierThisMonth': 'Plus tôt ce mois-ci',
  'inbox.bandLabel': '{title}, {count}',

  'inbox.unread': 'Non lu',
  'inbox.critical': 'Critique',
  'inbox.linkTo': 'Lien vers {host}',
  'inbox.rowKey': 'Clé {label}',
  ...
  'message.linksTo': 'Renvoie vers {host}',
  ...
  'message.copyTimestamp': "Copier l'horodatage",

  'keys.title': 'Clés',
  'keys.newKey': 'Nouvelle clé',
  'keys.active': { one: '1 active', other: '{n} actives' },
  'keys.criticalSummary': '{active} · {n} critiques',
  ...
  'keys.footnote':
    "Une clé n'est affichée qu'une fois, à sa création ; notifi ne stocke que le préfixe. " +
    'La clé par défaut peut être copiée à nouveau ou régénérée depuis sa page de détail.',
