...
export const de: Translation = {
  ...
  'inbox.bandEarlierThisWeek': 'Früher diese Woche',
  'inbox.bandEarlierThisMonth': 'Früher diesen Monat',
  'inbox.bandLabel': '{title}, {count}',

  'inbox.unread': 'Ungelesen',
  'inbox.critical': 'Kritisch',
  'inbox.linkTo': 'Link zu {host}',
  'inbox.rowKey': 'Schlüssel {label}',
  ...
  'message.linksTo': 'Verlinkt zu {host}',
  ...
  'message.copyTimestamp': 'Zeitstempel kopieren',

  'keys.title': 'Schlüssel',
  'keys.newKey': 'Neuer Schlüssel',
  'keys.active': { one: '1 aktiv', other: '{n} aktiv' },
  'keys.criticalSummary': '{active} · {n} kritisch',
  ...
  'keys.footnote':
    'Ein Schlüssel wird nur einmal angezeigt, bei seiner Erstellung; notifi speichert nur das Präfix. ' +
    'Der Standardschlüssel kann von seiner Detailseite aus erneut kopiert oder neu erzeugt werden.',
