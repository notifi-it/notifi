...
enum Copy {
    ...
    enum Age {
        ...
        static var absoluteFormat: String { NSLocalizedString("age.absoluteFormat", comment: "") }
    }
    enum Inbox {
        ...
        static var bandEarlierThisWeek: String { NSLocalizedString("inbox.bandEarlierThisWeek", comment: "") }
    ...
    enum Keys {
        ...
        static func active(_ n: Int) -> String { String.localizedStringWithFormat(NSLocalizedString("keys.active", comment: ""), n) }
        static func criticalSummary(_ active: String, _ n: String) -> String { String.localizedStringWithFormat(NSLocalizedString("keys.criticalSummary", comment: ""), active, n) }
